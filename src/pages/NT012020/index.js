...
export default function Virtualize() {
  ...
  useEffect(() => {
    function calcCargaIncendio() {
      ...
      cnaesSelecionados.map((valor) => {
        ...
        if (
          cnaes62251.some((e) => valor[2].includes(e))
    ...
    cnaes62251,
    cnaes62252,
    cnaesProjetoObrigatorio,
    cnaesSelecionados,
  ]);
  const verificarProjeto = () => {
    const link = (
      <a href="http://siapi.bombeiros.go.gov.br/cadastroSolicitacaoWeb.jsf">
        AQUI
      </a>
    );
    ...
    const Dispensada = () => (
      <>
        ...
        {' '}
        e solicite
        a Inspeção em sua Edificação.
      </>
    );
    const Necessita = () => (
      <>
        Edificação necessita de Aprovação de Projeto de Combate a Incêndio,
        conforme NT 01/2020.
        <br />
        Deverá ser contratado um Responsável Técnico para a Elaboração e
        Aprovação do Projeto e posteriormente solicitar a Inspeção na
        Edificação.
        <br />
  ...
  const verificarDispensa = () => {
    ...
    const Dispensada = () => (
      <>Edificação DISPENSADA de CERCON, NT01/2020 item 6.1.5.1.1.</>
    );
    const Previa = () => (
      <>
        Edificação deve ter o CERCON emitido pelo Processo Simplificado
        (Certificação Prévia).
        <br />
        Clique
        {' '}
  ...
  function removeCnae(e, index) {
    ...
    if (
      cnaes62251.some((el) => novosCnaes[index][2].includes(el))
      && Number(areaTotal) > 200
    ) {
      setPrevia62251('true');
    } else {
  ...
  useEffect(() => {
    resultadoProjeto.current.scrollIntoView({
      behavior: 'smooth',
      block: 'center',
    });
  }, [checkedProjeto, resultadoProjeto]);

  useEffect(() => {
    resultadoFormProjeto.current.scrollIntoView({
      behavior: 'smooth',
      block: 'center',
    });
  }, [formProjeto, resultadoFormProjeto]);
  ...
  useEffect(() => {
    ...
    cnaesProjeto,
    botijoesArmazenados,
    centralGlpEstacionario,
    comercioGlp,
    comercioExplosivos,
    distanciaEdificacoes,
    areaTotal,
    garagem,
    pavimentos,
    quantidadeLiquido,
  ...
  return (
    <Box pt={6}>
      ...
      <Container style={{ marginTop: '10px' }}>
          ...
          <Grid container direction="row">
            <Grid item lg={12}>
              <Typography variant="h5" align="center">
                Responda ao questionário abaixo e identifique qual Processo
                utilizar para regularizar edificação
                <IconButton onClick={openWarning}>
                  <ErrorOutlineIcon />
                </IconButton>
              </Typography>
            </Grid>
          ...
          >
            <Grid container>
              <Grid
                item
                lg={
                  prestadorDeServico === 'false' || prestadorDeServico === ''
                    ? 11
                    : 6
                }
                md={12}
              ...
              >
                <FormControl component="fieldset">
                  <FormLabel component="legend">
                    A EMPRESA É NA RESIDÊNCIA DO EMPREENDEDOR, SEM RECEPÇÃO DE
                    PESSOAS?
                  </FormLabel>
                  <RadioGroup
                    row
                    value={prestadorDeServico}
                    onChange={(e) => setPrestadorDeServico(e.target.value)}
                  >
                    <FormControlLabel
                      value="true"
                      control={<Radio />}
              ...
              >
                <Typography variant="h5" align="center">
                  Dispensado de CERCON
                </Typography>
                <Typography variant="body1" gutterBottom>
                  Conforme NT01/2020: 6.1.5.1.1 Considera-se atividade econômica
                  de baixo risco as atividades realizadas: a.Na residência do
                  empreendedor, sem recepção de pessoas; A emissão do
                  Certificado de Conformidade é dispensada para essa categoria,
                  e é optativa ao responsável.
                </Typography>
              </Grid>
            </Grid>
          </Box>
        ...
        <Grid
          hidden={prestadorDeServico === 'true' || prestadorDeServico === ''}
          container
          justify="center"
          spacing={2}
        >
          <Grid item xs={12}>
            <FormLabel component="legend">
              INFORME OS CNAE's E AS RESPECTIVAS ÁRES NO ESTABELECIMENTO:
            </FormLabel>
          </Grid>
          <Grid item lg={8} xl={8} md={8} xs={12}>
            <Autocomplete
              ...
              options={OPTIONS}
              renderInput={(params) => (
                <TextField {...params} variant="outlined" label="CNAE" />
              )}
          ...
          <Grid item lg={12} md={12} xs={12}>
            <FormControl component="fieldset">
              <FormLabel component="legend">
                O EMPREENDIMENTO ESTA LOCALIZADO EM ALGUM CONDOMÍNIO COMERCIAL,
                SHOPPING, GALERIA OU SEMELHANTE?
              </FormLabel>
              <RadioGroup
                row
                value={edificacao}
          ...
          <Grid
            item
            hidden={edificacao === 'false' || edificacao === ''}
            lg={12}
            md={12}
            xs={12}
          >
            <FormControl component="fieldset">
              <FormLabel component="legend">
                ESTE CONDOMÍNIO COMERCIAL/SHOPPING/GALERIA POSSUI ATÉ 750m² DE
                ÁREA CONSTRUÍDA OU MENOS DE 03 PAVIMENTOS?
              </FormLabel>
              <RadioGroup
                row
                value={tamanhoEdificacao}
                onChange={(e) => setTamanhoEdificacao(e.target.value)}
              >
                <FormControlLabel
                  value="true"
                  control={<Radio />}
          ...
          <Grid item lg={12} md={12} xs={12}>
            <FormControl component="fieldset">
              <FormLabel component="legend">
                POSSUI ABERTURAS PARA O INTERIOR DA EDIFICAÇÃO OU
          ...
          <Grid item lg={12} md={12} xs={12}>
            <FormControl component="fieldset">
              <FormLabel component="legend">
                QUAL A LOTAÇÃO DO ESTABELECIMENTO?
              </FormLabel>
              <RadioGroup
                row
                value={lotacao}
          ...
          <Grid item lg={12} md={12} xs={12}>
            <FormLabel component="legend">
              O SEU ESTABELECIMENTO POSSUI QUANTOS PAVIMENTOS?
            </FormLabel>
            <FormControl component="fieldset">
              <TextField
                id="outlined-number"
          ...
          <Grid item lg={12} md={12} xs={12}>
            <FormControl component="fieldset">
              <FormLabel component="legend">
                O SEU ESTABELECIMENTO POSSUI SUBSOLO?
              </FormLabel>
              <RadioGroup
                row
                value={subsolo}
          ...
          <Grid
            item
            hidden={subsolo === 'dispensado' || subsolo === ''}
            lg={12}
            md={12}
            xs={12}
          >
            <FormControl component="fieldset">
              <FormLabel component="legend">
                O SUBSOLO É UTILIZADO SOMENTE COMO GARAGEM / ESTACIONAMENTO?
              </FormLabel>
              <RadioGroup
                value={garagem}
                row
          ...
          <Grid item lg={12} md={12} xs={12}>
            <FormControl component="fieldset">
              <FormLabel component="legend">
                POSSUI LÍQUIDO INFLAMÁVEL OU COMBUSTÍVEL NO ESTABELECIMENTO?
              </FormLabel>
              <RadioGroup
                row
          ...
          <Grid
            item
            hidden={
              liquidoInflamavel === 'dispensado' || liquidoInflamavel === ''
            }
            lg={12}
            md={12}
            xs={12}
          >
            <FormControl component="fieldset">
              <FormLabel component="legend">
                QUAL A QUANTIDADE DE LÍQUIDO INFLAMÁVEL E/OU COMBUSTÍVEL QUE
                POSSUI?
              </FormLabel>
              <RadioGroup
                row
                value={quantidadeLiquido}
                onChange={(e) => setquantidadeLiquido(e.target.value)}
              >
                <FormControlLabel
                  value="dispensado"
                  control={<Radio />}
                  label="Até 250 litros"
                />
                <FormControlLabel
                  value="previa"
                  control={<Radio />}
                  label="Entre 251 e 500 litros"
                />
                <FormControlLabel
                  value="vistoria"
                  control={<Radio />}
                  label="Mais de 501 litros"
                />
              </RadioGroup>
            </FormControl>
          </Grid>
          ...
          >
            <FormControl component="fieldset">
              <FormLabel component="legend">
                QUAL A CAPACIDADE DE BOTIJÃO UTILIZADO?
              </FormLabel>
              <RadioGroup
                row
                value={capacidadeGlp}
                onChange={(e) => setCapacidadeGlp(e.target.value)}
              >
                <FormControlLabel
                  value="dispensado"
                  control={<Radio />}
                ...
                <FormControlLabel
                  value="previa"
                  control={<Radio />}
                  label="de 14kg até 190kg"
                />
                <FormControlLabel
                  value="vistoria"
                  control={<Radio />}
                  label="Acima de 191kg"
                />
                <FormControlLabel
                  hidden={edificacao != 'true'}
                  value="central"
                  control={<Radio />}
                  label="Utiliza GLP da Central de GLP do edifício"
                />
              </RadioGroup>
            </FormControl>
          </Grid>
        ...
        <Box hidden={!formProjeto} ref={resultadoFormProjeto} my={4}>
          <Box mb={2}>
            <Typography mb={2} variant="h6">
              Responda as perguntas abaixo para verificar se necessita de
              projeto, conforme item 6.2.3.2 da NT 01/2020:
            </Typography>
          </Box>
          <Grid item lg={12} mt={2} md={12} xs={12}>
            ...
            <Grid item lg={12} md={12} xs={12}>
              <FormControl component="fieldset">
                <FormLabel component="legend">
                  ARMAZENA 6 OU MAIS BOTIJÕES DE GLP DO TIPO P-13?
                </FormLabel>
                <RadioGroup
                  row
            ...
            <Grid item lg={12} md={12} xs={12}>
              <FormControl component="fieldset">
                <FormLabel component="legend">
                  POSSUI CENTRAL DE GLP COM BOTIJÃO ESTACIONÁRIO?
                </FormLabel>
                <RadioGroup
                  row
            ...
            <Grid item lg={12} md={12} xs={12}>
              <FormControl component="fieldset">
                <FormLabel component="legend">
                  PRODUZ, ARMAZENA OU COMERCIALIZA EXPLOSIVOS OU FOGOS DE
                  ARTIFÍCIOS?
                </FormLabel>
                <RadioGroup
                  row
            ...
            <Grid item lg={12} md={12} xs={12}>
              <FormControl component="fieldset">
                <FormLabel component="legend">
                  POSSUI OUTRA EDIFICAÇÃO NO MESMO LOTE?
                </FormLabel>
                <RadioGroup
                  row
            ...
            <Grid
              item
              hidden={
                edificacaoMesmoLote === 'dispensado'
                || edificacaoMesmoLote === ''
              }
              lg={12}
              md={12}
            ...
            >
              <FormControl component="fieldset">
                <FormLabel component="legend">
                  POSSUI MENOS QUE 12 METROS DE DISTÂNCIA DE OUTRA EDIFICAÇÃO NO
                  MESMO LOTE?
                </FormLabel>
                <RadioGroup
                  row
          ...
          <Grid
            align="center"
            ref={resultadoProjeto}
            id="resultado"
            hidden={!checkedProjeto}
            item
            xs={12}
          >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <Typography variant="body1" paragraph>
              Esta ferramente deve ser usada somente como auxílio na verificação
              de empresas.
            </Typography>
            <Typography variant="body1" paragraph>
              <b>
                Todas as perguntas devem ser respondidas para obter uma resposta
                correta. O resultado pode ser incorreto caso alguma pergunta não
                seja respondida.
              </b>
            </Typography>
            <Typography variant="body1" paragraph>
              Em caso de dúvidas, verifique as Normas Técnicas 01 e 14, e todas
              as demais que achar necessário.
            </Typography>
            <Typography variant="body1" paragraph>
              Esta ferramenta foi criada com base nos itens 5.2.2, 6.1.3,
              6.1.5.1, 6.1.5.2, 6.2.2.5 e 6.2.3.2 da NT-01/2020, Anexo A da
              NT-01/2020 e Anexo A da NT-14/2020.
            </Typography>
            <Typography variant="body1" paragraph>
              Use com atenção.
            </Typography>
